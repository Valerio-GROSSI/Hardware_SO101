my_cool_robot_description_package\n\n
...
2. Install the package by calling `colcon build --symlink-install --packages-select my_cool_robot_description_package`
3. (Re-)Source environment `source install/setup.bash`


> **NOTE:** If you use [RosTeamWorkspace (RTW)](https://rtw.b-robotized.com) than instead of the previous three steps, use `cb my_cool_robot_description_package` command.

Now, launch description test:
```
ros2 launch my_cool_robot_description_package view_my_cool_robot_name.launch.xml
```
or
```
ros2 launch my_cool_robot_description_package view_my_cool_robot_name.launch.py
```
