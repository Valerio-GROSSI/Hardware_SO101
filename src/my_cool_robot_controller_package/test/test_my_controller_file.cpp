...
#include "test_my_controller_file.hpp"

using my_cool_robot_controller_package::CMD_MY_ITFS;
using my_cool_robot_controller_package::control_mode_type;
using my_cool_robot_controller_package::STATE_MY_ITFS;

class MyControllerFileTest : public MyControllerFileFixture<TestableMyControllerFile>
{
};

TEST_F(MyControllerFileTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(MyControllerFileTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(MyControllerFileTest, activate_success)
{
  SetUpController();
...
TEST_F(MyControllerFileTest, update_success)
{
  SetUpController();
...
TEST_F(MyControllerFileTest, deactivate_success)
{
  SetUpController();
...
TEST_F(MyControllerFileTest, reactivate_success)
{
  SetUpController();
...
TEST_F(MyControllerFileTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(MyControllerFileTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(MyControllerFileTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(MyControllerFileTest, publish_status_success)
{
  SetUpController();
...
TEST_F(MyControllerFileTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
